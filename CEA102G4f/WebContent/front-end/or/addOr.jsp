								...
								<div class="row px-2">
									...
									<div class="form-group col-md-6">
										<label class="form-control-label">金額</label> <input
											type="text" id="cnum" name="or_price" placeholder="金額"
											value="<%=request.getParameter("or_price")%>" readonly>
									</div>
								</div>
								<div class="row px-2">
									<div class="form-group col-md-6">
										<label class="form-control-label">收貨人</label> <input
											type="text" id="cname" name="or_name" required> <input
