		...
		<div class="content">
			<div class=bidleft>
				...
				<div>
					...
					<h4>
						起標價格:&nbsp;&nbsp;&nbsp;&nbsp;TWD$  <span class="bidPricestart">${bidVO.bidPricestart}</span>
					</h4>
			...
			<div class="bidleftdown">
				<div class="price">
					...
					<h4>
						目前競標價格:&nbsp;&nbsp;&nbsp;TWD$ <span class="now_firstprice">${bidVO.bidPricestart}</span>&nbsp;&nbsp;&nbsp;
					</h4>
...
// 			}
	...
	var MyPoint = "/websocket/"+$(".bidNo").val();
			...
			if(jsonObj.hasOwnProperty("other") && countttt == 0){
				...
				if(jsonObj.mem_id == $(".memberidsave").attr("id")){			
					...
					let str1 ='<div class="nowmessagego"> <div class="nowmessagetext" id="chat-main">'
								...
								+'<h2>得標金額為:  TWD$ <span> '+jsonObj.bid_price+ '</span>  已從錢包扣款</h2> '
			...
			for(var k in jsonObj) {
				...
				if(k==0){
					...
					message+='<div class="member_bid">'+
						...
						'<p class="p3">TWD$</p><p class="p2">'+jsonObj[k].bid_price+'</p>'+'<p class="p3">'+arr[1]+'</p></div>';
				
						}else{
							var arr = jsonObj[k].bid_time.split(' ');
	// 						//console.log(arr[1]);
							message+='<div class="bid_othermem"><p class="p1">'+jsonObj[k].mem_nick+
							'</p><p class="p3">TWD$</p><p class="p2">'+jsonObj[k].bid_price+'</h3><p class="p3">'+arr[1]+'</p></div>'
