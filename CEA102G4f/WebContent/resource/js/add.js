...
//	// AddressSeleclList.Initialize('cityb1', 'cityb2', 'Please Select City',
//	// '0', 'Please Select Area', '0');
//}
...
function show() {
	// 取出指定縣市及鄉鎮市區的下拉選單的值
	// alert(AddressSeleclList.ReturnSelectAddress('citya1', 'citya2'));
	var last = document.getElementById("last").value = AddressSeleclList
			.ReturnSelectAddress('citya1', 'citya2');
}
...
var app = window.AddressSeleclList = {
	...
	ReturnSelectAddress : function(city, area) {
		...
		return city.value + "," + area.value + "," + area2.value;
	}
